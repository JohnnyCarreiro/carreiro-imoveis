...
import { Container, Parallax, Wrapper } from '@/styles/parallax'
import BGImage1 from '@/images/houses/california.jpg'
import BGImage2 from '@/images/houses/san_jose.jpg'
...
export default function Paralax({ children }: ParalaxProps) {
  return (
    <Container>
      <Wrapper>
        <p>
